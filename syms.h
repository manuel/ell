...
ELL_DEFSYM(core_unsyntax, "ell_unsyntax")
ELL_DEFSYM(core_unsyntax_splicing, "ell_unsyntax_splicing")
ELL_DEFSYM(core_syntax_list, "ell_syntax_list")
ELL_DEFSYM(core_append_syntax_lists, "ell_append_syntax_lists")
