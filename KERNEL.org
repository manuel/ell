...
** Types
*** deftype name type -> nil [special]
Establishes a universally quantified type, that's a subtype of the
given type expression, in the current environment.  Used for static
type safety through recursive types.
** Classes
...
** Methods
*** defmethod class method-name sig body -> nil [function]
